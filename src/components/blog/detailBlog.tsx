      ...
      <div className="w-full p-12 bg-white">
        ...
        <div className="grid grid-cols-1 gap-12 md:grid-cols-2 xl:grid-cols-3">
          {blogs.map((blog: blogType,key:number) => {
            return (
              <div key={key} className="m-auto overflow-hidden rounded-lg shadow-lg cursor-pointer h-90 w-60 md:w-80">
                <a href="/detailBlog" className="hover:drop-shadow-xl delay-150 bg-blue-500 hover:w-[110%] block w-full h-full">
                  <img
                    alt="blog photo"
                    src={blog.picture}
